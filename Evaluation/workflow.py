...
def workflow(Adid) :
    ...
    fn_out_ad2userCTR_transfer = TMP_DATA_DIR_PATH + 'evaluation/%s.ad2userCTR.transfer'
    fn_out_ad2userCTR_relevance = TMP_DATA_DIR_PATH + 'evaluation/%s.ad2userCTR.transfer.relevance'
    ...
    displayGlobalResult(fn_out_ad2userCTR, fn_out_ad2userCTR_transfer, fn_out_ad2userCTR_relevance, 5, False)
